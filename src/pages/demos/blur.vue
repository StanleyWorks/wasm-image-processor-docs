  ...
  <div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 mb-8">
      <form action="#" @submit.prevent="onSubmit">
        ...
        <div class="mb-5">
          <label for="sigma" class="block text-gray-700 font-medium mb-2"
            >Blur Sigma</label
          >
          <input
            id="sigma"
    ...
    <div v-if="previewUrl || processedImageUrl" class="mb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div v-if="processedImageUrl" class="flex flex-col items-center">
          ...
          <div v-if="processedImage" class="mt-2 text-sm text-gray-500">
            Size: {{ useFileSize(processedImage) }}
          </div>
          <div>
            <a
              v-if="processedImage"
              download
              :href="useCreateObjectUrl(processedImage)"
              >Download</a
            >
          </div>
        </div>
